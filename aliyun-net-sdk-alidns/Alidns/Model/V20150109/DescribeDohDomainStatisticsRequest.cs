...
{
    public class DescribeDohDomainStatisticsRequest : RpcAcsRequest<DescribeDohDomainStatisticsResponse>
    {
        public DescribeDohDomainStatisticsRequest()
            : base("Alidns", "2015-01-09", "DescribeDohDomainStatistics", "alidns", "openAPI")
        {
        ...
        public override DescribeDohDomainStatisticsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDohDomainStatisticsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
