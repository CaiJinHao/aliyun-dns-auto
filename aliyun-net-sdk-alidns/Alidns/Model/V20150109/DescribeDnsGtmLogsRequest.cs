...
{
    public class DescribeDnsGtmLogsRequest : RpcAcsRequest<DescribeDnsGtmLogsResponse>
    {
        public DescribeDnsGtmLogsRequest()
            : base("Alidns", "2015-01-09", "DescribeDnsGtmLogs", "alidns", "openAPI")
        {
        ...
        public override DescribeDnsGtmLogsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDnsGtmLogsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
