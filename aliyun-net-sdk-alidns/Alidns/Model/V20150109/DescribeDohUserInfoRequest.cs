...
{
    public class DescribeDohUserInfoRequest : RpcAcsRequest<DescribeDohUserInfoResponse>
    {
        public DescribeDohUserInfoRequest()
            : base("Alidns", "2015-01-09", "DescribeDohUserInfo", "alidns", "openAPI")
        {
        ...
        public override DescribeDohUserInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDohUserInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
