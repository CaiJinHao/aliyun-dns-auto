...
{
    public class MoveDomainResourceGroupRequest : RpcAcsRequest<MoveDomainResourceGroupResponse>
    {
        public MoveDomainResourceGroupRequest()
            : base("Alidns", "2015-01-09", "MoveDomainResourceGroup", "alidns", "openAPI")
        {
        ...
        public override MoveDomainResourceGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return MoveDomainResourceGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
