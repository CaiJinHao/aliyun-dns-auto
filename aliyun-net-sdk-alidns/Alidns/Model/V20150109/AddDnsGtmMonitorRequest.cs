...
{
    public class AddDnsGtmMonitorRequest : RpcAcsRequest<AddDnsGtmMonitorResponse>
    {
        public AddDnsGtmMonitorRequest()
            : base("Alidns", "2015-01-09", "AddDnsGtmMonitor", "alidns", "openAPI")
        {
        ...
        public override AddDnsGtmMonitorResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddDnsGtmMonitorResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
