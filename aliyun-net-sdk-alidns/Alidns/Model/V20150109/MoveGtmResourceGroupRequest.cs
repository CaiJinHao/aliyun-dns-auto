...
{
    public class MoveGtmResourceGroupRequest : RpcAcsRequest<MoveGtmResourceGroupResponse>
    {
        public MoveGtmResourceGroupRequest()
            : base("Alidns", "2015-01-09", "MoveGtmResourceGroup", "alidns", "openAPI")
        {
        ...
        public override MoveGtmResourceGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return MoveGtmResourceGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
