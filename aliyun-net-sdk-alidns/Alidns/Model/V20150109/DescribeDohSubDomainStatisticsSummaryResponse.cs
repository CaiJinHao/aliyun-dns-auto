...
{
	public class DescribeDohSubDomainStatisticsSummaryResponse : AcsResponse
	{
		...
		private List<DescribeDohSubDomainStatisticsSummary_Statistic> statistics;
		...
		public List<DescribeDohSubDomainStatisticsSummary_Statistic> Statistics
		{
			get
			{
				return statistics;
		...
		public class DescribeDohSubDomainStatisticsSummary_Statistic
		{
