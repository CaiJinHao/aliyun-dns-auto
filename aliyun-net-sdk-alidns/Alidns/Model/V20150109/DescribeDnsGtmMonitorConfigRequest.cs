...
{
    public class DescribeDnsGtmMonitorConfigRequest : RpcAcsRequest<DescribeDnsGtmMonitorConfigResponse>
    {
        public DescribeDnsGtmMonitorConfigRequest()
            : base("Alidns", "2015-01-09", "DescribeDnsGtmMonitorConfig", "alidns", "openAPI")
        {
        ...
        public override DescribeDnsGtmMonitorConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDnsGtmMonitorConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
