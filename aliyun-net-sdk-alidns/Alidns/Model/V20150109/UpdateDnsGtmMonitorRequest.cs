...
{
    public class UpdateDnsGtmMonitorRequest : RpcAcsRequest<UpdateDnsGtmMonitorResponse>
    {
        public UpdateDnsGtmMonitorRequest()
            : base("Alidns", "2015-01-09", "UpdateDnsGtmMonitor", "alidns", "openAPI")
        {
        ...
        public override UpdateDnsGtmMonitorResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateDnsGtmMonitorResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
