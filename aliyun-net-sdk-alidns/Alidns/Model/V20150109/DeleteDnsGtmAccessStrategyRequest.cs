...
{
    public class DeleteDnsGtmAccessStrategyRequest : RpcAcsRequest<DeleteDnsGtmAccessStrategyResponse>
    {
        ...
        public override DeleteDnsGtmAccessStrategyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteDnsGtmAccessStrategyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
