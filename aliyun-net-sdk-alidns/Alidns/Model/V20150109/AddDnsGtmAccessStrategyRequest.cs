...
{
    public class AddDnsGtmAccessStrategyRequest : RpcAcsRequest<AddDnsGtmAccessStrategyResponse>
    {
        public AddDnsGtmAccessStrategyRequest()
            : base("Alidns", "2015-01-09", "AddDnsGtmAccessStrategy", "alidns", "openAPI")
        {
        ...
        public override AddDnsGtmAccessStrategyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddDnsGtmAccessStrategyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
