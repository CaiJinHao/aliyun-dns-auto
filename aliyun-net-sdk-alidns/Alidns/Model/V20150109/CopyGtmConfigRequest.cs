...
{
    public class CopyGtmConfigRequest : RpcAcsRequest<CopyGtmConfigResponse>
    {
        public CopyGtmConfigRequest()
            : base("Alidns", "2015-01-09", "CopyGtmConfig", "alidns", "openAPI")
        {
		...
		public string CopyType
		{
			...
			{
				copyType = value;
				DictionaryUtil.Add(QueryParameters, "CopyType", value);
			}
		}
        ...
        public override CopyGtmConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CopyGtmConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
